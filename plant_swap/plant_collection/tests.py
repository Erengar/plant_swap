...
class test_front_page_selenium(StaticLiveServerTestCase):
    ...
    def test_front_page_like(self):
        ...
        element = WebDriverWait(self.selenium, 10).until(
            EC.element_to_be_clickable((By.XPATH, '/html/body/section/div/div/div/div[2]/div[2]/div[2]/div[1]/a/i')))
        element.click()
    ...
    def test_my_collection_like(self):
        ...
        self.selenium.find_element(By.CSS_SELECTOR, 'input.button').click()
        element = WebDriverWait(self.selenium, 10).until(
            EC.element_to_be_clickable((By.XPATH, '/html/body/section/div/div[2]/div/div[2]/div[2]/div[2]/div[1]/a/i')))
        element.click()
        WebDriverWait(self.selenium, 10).until(
            EC.presence_of_element_located((By.CLASS_NAME, 'has-text-danger.fa-solid.fa-heart')))
        heart = self.selenium.find_element(By.CLASS_NAME, 'has-text-danger.fa-solid.fa-heart')
    ...
    def test_plant_detail_like(self):
        ...
        password.send_keys('Liteon987')
        self.selenium.find_element(By.CSS_SELECTOR, 'input.button').click()
        self.selenium.find_element(By.XPATH, '/html/body/section/div/div[2]/div/div[1]/figure/a/img').click()
        element = WebDriverWait(self.selenium, 10).until(
            EC.element_to_be_clickable((By.XPATH, '/html/body/section/div/div/div[2]/div/div/section[1]/div[3]/div[1]/a/i')))
        element.click()
        WebDriverWait(self.selenium, 10).until(
            EC.presence_of_element_located((By.CLASS_NAME, 'has-text-danger.fa-solid.fa-heart')))
        heart = self.selenium.find_element(By.CLASS_NAME, 'has-text-danger.fa-solid.fa-heart')
    ...
    def test_add_plant(self):
        ...
        password.send_keys('Liteon987')
        self.selenium.find_element(By.CSS_SELECTOR, 'input.button').click()
        self.selenium.find_element(By.XPATH, '/html/body/section/div/div[1]/a/div').click()
