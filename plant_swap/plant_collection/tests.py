...
class test_front_page_selenium(StaticLiveServerTestCase):
    ...
    def test_front_page_like(self):
        ...
        self.selenium.find_element(By.CSS_SELECTOR, "input.button").click()
        self.selenium.find_element(By.XPATH, "/html/body/nav/div[1]/a[1]").click()
        element = WebDriverWait(self.selenium, 10).until(
            EC.element_to_be_clickable(
                (
                    By.XPATH,
                    "/html/body/section/div/div/div/div[2]/div[2]/div[2]/div[1]/a/i",
                )
            )
        )
        element.click()
        WebDriverWait(self.selenium, 10).until(
            EC.presence_of_element_located(
                (By.CLASS_NAME, "has-text-danger.fa-solid.fa-heart")
            )
        )
        heart = self.selenium.find_element(
            By.CLASS_NAME, "has-text-danger.fa-solid.fa-heart"
        )
        return self.assertIn(
            "has-text-danger fa-solid fa-heart", heart.get_attribute("class")
        )
    ...
    def test_my_collection_like(self):
        ...
        element = WebDriverWait(self.selenium, 10).until(
            EC.element_to_be_clickable(
                (
                    By.XPATH,
                    "/html/body/section/div/div[2]/div/div[2]/div[2]/div[2]/div[1]/a/i",
                )
            )
        )
        element.click()
    ...
    def test_plant_detail_like(self):
        ...
        self.selenium.find_element(
            By.XPATH, "/html/body/section/div/div[2]/div/div[1]/figure/a/img"
        ).click()
        element = WebDriverWait(self.selenium, 10).until(
            EC.element_to_be_clickable(
                (
                    By.XPATH,
                    "/html/body/section/div/div/div[2]/div/div/section[1]/div[3]/div[1]/a/i",
                )
            )
        )
        element.click()
    ...
    def test_carousel(self):
        ...
        first_images = self.selenium.find_elements(
            By.CSS_SELECTOR, 'div.carousel_image[hidden="true"]'
        )
        self.selenium.find_element(By.ID, "right-btn").click()
        second_images = self.selenium.find_elements(
            By.CSS_SELECTOR, 'div.carousel_image[hidden="true"]'
        )
    ...
    def test_add_plant(self):
        ...
        self.selenium.find_element(By.CSS_SELECTOR, "input.button").click()
        self.selenium.find_element(
            By.XPATH, "/html/body/section/div/div[1]/a/div"
        ).click()
        self.selenium.find_element(By.XPATH, '//*[@id="input_tag0"]').send_keys(
            "test.jpg"
        )
